...
<div class="">
  ...
  <form class="" action="{{url('/skill')}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    <h4 style="padding-bottom:20px;">Crear Nueva Habilidad</h4>
    <div class="row">
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
              ...
              <label class="card-text" for="">{{'Descripción:'}}</label><br>
              <textarea name="description" id="description" rows="6" cols="71"></textarea>
