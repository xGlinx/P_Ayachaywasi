...
<div class="">
  ...
  <div class="second-section" style="margin-left:255px;"> <!--Formulario-->
    <div class="row row-cols-1 row-cols-md-3">
      ...
      <div class="card bg-light mb-3" style="max-width: 18rem; margin-left:10px; text-align:center;">
        <div class="card-header">Ruta de Aprendizaje</div>
        <div class="card-body">
          <h5 class="card-title">{{$path->name}}</h5>
          <img src="{{asset('storage').'/'.$path->picture}}" class="card-img-top" alt="..." style="width:60px;height:60px;">
        </div>
        <div class="card-footer"><a class="btn btn-success" href="{{url('/path_subject/'.$path->path_id.'/edit')}}">Iniciar</a></div>
      </div>
      <?php endforeach;?>
