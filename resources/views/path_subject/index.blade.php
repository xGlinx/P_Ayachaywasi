...
<div class="">
  ...
  <div class="list-group">
   <?php foreach ($subjects as $subject) :?>
    <img src="{{ asset('img/people.png') }}" width="30" height="30" class="d-inline-block align-top" alt="">
    <a href="{{url('/subject/'.$subject->subject_id.'/edit')}}" class="list-group-item list-group-item-success">{{$subject->name}}</a>
   <?php endforeach;?>
  </div>
  </div>
  ...
  <p class="display-4" style="text-align:center; font-size:40px;">{{$paths->name}}</p>
  <p>{{$paths->description}}</p>
  <p>{{$paths->detail}}</p>
  <div class="embed-responsive embed-responsive-16by9">
    <iframe width="450" height="315" src="{{$paths->video}}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div><br>
  <?php endforeach;?>
  </div>
