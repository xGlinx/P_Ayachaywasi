...
<div class="">
  ...
  <div class="second-section" style="margin-left:255px; height:450px;"> <!--Formulario-->

<label for="" class="display-4" style="margin-left">Pago exitoso</label><br><br>
<a href="{{url('/student')}}" class="btn btn-success">Volver al Inicio</a>
